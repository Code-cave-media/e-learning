...
const allCourses = [
  ...
  },
  {
    ...
    price: 39.99,
    imageUrl: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&w=800",
    isNew: true,
  },
  {
    id: "5",
    ...
    price: 79.99,
    imageUrl: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&w=800",
  },
  {
    id: "6",
    ...
    price: 54.99,
    imageUrl: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&w=800",
    isFeatured: true,
  },
];

// User's purchased courses
const myCourses = allCourses.slice(0, 2).map(course => ({ ...course, isPurchased: true }));
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Discover and learn with our professional courses.</p>
      </div>
