...
const allEbooks = [
  ...
  },
  {
    ...
    price: 24.99,
    coverUrl: "https://images.unsplash.com/photo-1582562124811-c09040d0a901?auto=format&w=800",
    isNew: true,
  },
  {
    id: "3",
    ...
    price: 17.99,
    coverUrl: "https://images.unsplash.com/photo-1721322800607-8c38375eef04?auto=format&w=800",
  },
  {
    id: "4",
    title: "Cloud Architecture Fundamentals",
    description: "Understand cloud computing models, services, and best practices.",
    price: 29.99,
    coverUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&w=800",
    isNew: true,
  },
  {
    id: "5",
    title: "Web Security Handbook",
    description: "Practical guide for securing web applications and preventing attacks.",
    price: 22.99,
    coverUrl: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?auto=format&w=800",
    isFeatured: true,
  },
];

// User's purchased ebooks
const myEbooks = allEbooks.slice(0, 1).map(ebook => ({ ...ebook, isPurchased: true }));
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Expand your knowledge with our professional eBooks.</p>
      </div>
