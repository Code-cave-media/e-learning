  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage your affiliate marketing and earnings.</p>
      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setPaymentMode(value as "upi" | "bank")}
                    >
                      <SelectTrigger>
                  ...
                  {paymentMode === "upi" && (
                    <div>
                      ...
                      <Input id="upi" type="text" placeholder="name@bankname" required />
                    </div>
                  )}
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-semibold">Complete Web Development Bootcamp</span>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-semibold">React Patterns & Best Practices</span>
